...
NOTE: Plan 02 Task 1 creates the KaldiRecognizer in this sequence (after AudioContext, before audio pipeline):
```javascript
// From Plan 02 Task 1, step 4:
this._recognizer = new this._model.KaldiRecognizer(this._sampleRate);
```

Add this event listener code immediately after the recognizer creation line:
