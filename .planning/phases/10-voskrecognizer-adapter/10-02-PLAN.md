...
3. Verify ScriptProcessor created with buffer size 4096
4. Verify acceptWaveform called in onaudioprocess handler
5. Verify error handling for microphone permission errors
  </verify>
