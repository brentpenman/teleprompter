...
Plans:
- [x] 06-01-PLAN.md — TDD: Core PositionTracker with two-position model and monotonic constraint
- [x] 06-02-PLAN.md — TDD: Skip detection with distance-dependent consecutive matching
